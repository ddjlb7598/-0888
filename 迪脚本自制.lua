...
game:GetService("StarterGui"):SetCore("SendNotification",{ Title = "欢迎使用迪脚本"; Text ="启动中"; Duration = 2; })
game:GetService("StarterGui"):SetCore("SendNotification",{ Title = "正在加载"; Text ="启动完毕"; Duration = 4; })

local ui = loadstring(game:HttpGet("https://raw.githubusercontent.com/ddjlb7598/-3.0000/refs/heads/main/%E5%A4%A7%E5%8F%B8%E9%A9%ACLOL%20UI.lua"))();        
local win = ui:new("迪脚本")
--
...
about:Label("迪脚本")
about:Label("开发团队就两个人")
about:Label("qq群908685870")
about:Label("xx")
about:Label("xxx")
...
about:Label("")
about:Label("")
local UITab3 = win:Tab("『佰染』",'7734068321')

local about = UITab3:section("『佰染』",true)

about:Button("陌染死铁鬼脚本",function()
...
about:Button("陌染最强战场脚本",function()
    loadstring(game:HttpGet("https://raw.githubusercontent.com/moran701/morandingzhi/refs/heads/main/%E6%9C%80%E5%BC%BA%E6%88%98%E5%9C%BA"))()
end)
about:Button("陌染脚本",function()
...
about:Button("脚本",function()
    loadstring(game:HttpGet("填你的脚本网址"))()
end)
about:Button("脚本",function()
    loadstring(game:HttpGet("填你的脚本网址"))()
end)
about:Button("xx脚本",function()
    loadstring(game:HttpGet("填你的脚本网址"))()
end)
about:Button("xx脚本",function()
    loadstring(game:HttpGet("填你的脚本网址"))()
...
local UITab4 = win:Tab("『通用』",'7734068321')
...
local UITab5 = win:Tab("『FE』",'7734068321')
...
local UITab6 = win:Tab("『其他脚本』",'7734068321')

local about = UITab6:section("『其他脚本』",true)

about:Button("迪脚本",function()
...
local UITab7 = win:Tab("『实用工具』",'7734068321')

local about = UITab7:section("『实用工具』",true)

about:Button("翻译脚本",function()
...
local UITab8 = win:Tab("『服务器脚本』",'7734068321')

local about = UITab8:section("『服务器脚本』",true)
